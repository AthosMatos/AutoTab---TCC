...
def define_models(n_input, n_output, n_features, n_units):
    ...
    state_h_encoder = Concatenate()([state_h_encoder_f, state_h_encoder_b])
    state_c_encoder = Concatenate()([state_c_encoder_f, state_c_encoder_b])
    ...
    decoder_state_input_h = Input(shape=(n_units * 2,), name="decoder_state_input_h")
    decoder_state_input_c = Input(shape=(n_units * 2,), name="decoder_state_input_c")
...
# define model
train_model, encoder, decoder = define_models(2, 2, n_classes, 128)
...
TIMES, NOTES = gen_dataset(n_steps_in, n_steps_out, n_classes, n_out_gen, 10000)
...
for _ in range(10):
    TIMES, NOTES = gen_dataset(n_steps_in, n_steps_out, n_classes, n_out_gen, 1)
