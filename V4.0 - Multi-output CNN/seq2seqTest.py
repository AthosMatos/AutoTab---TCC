...
out_notes = TimeDistributed(Dense(84, activation="relu"))(x)
...
# out_times = TimeDistributed(Dense(128, activation="relu"))(x)
out_times = TimeDistributed(Dense(64, activation="relu"))(x)
