...
def filt(path, index, stereo=False):
    ...
    axis[1, index].set_title('0.12seg')
...
filt(relative_path + '/audio/leadNoDist.wav', 0)
filt(relative_path + '/audio/leadNoDist.wav', 1)
filt(relative_path + '/audio/leadNoDist.wav', 2)
plt.title('leadNoDist distortion')
