...
def filt(path, index, stereo=False):
    ...
    melSpec2 = calc_melSpec(audio[:int(sr * 1)], sr, 256, index=index)
...
filt(relative_path + '/audio/rythmNoDist.wav', 0)
filt(relative_path + '/audio/rythmNoDist.wav', 1)
filt(relative_path + '/audio/rythmNoDist.wav', 2)
plt.title('rythmNoDist distortion')
plt.show()
