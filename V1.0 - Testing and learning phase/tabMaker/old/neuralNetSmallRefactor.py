...
from prepareTrain import audio_inputs, notes_outputs
...
def buildModel(summary = False):
    ...
    notes_class_model = notes_classifier_branch(CNN_inputs, all_notes.__len__())
    notes_output = notes_class_model.output
    gainLevel_class_model = gainLevel_classifier_branch(CNN_inputs, all_gainLevels.__len__())
    gainLevel_output = gainLevel_class_model.output
    amplifier_class_model = amplifier_classifier_branch(CNN_inputs, all_amps.__len__())
