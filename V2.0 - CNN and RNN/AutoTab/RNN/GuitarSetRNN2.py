...
""" 
TimeDistributed(Conv2D(32, (3, 3), activation="tanh")),
        TimeDistributed(MaxPooling2D((2, 2))),
        TimeDistributed(
            Dropout(0.25),
        ),
        TimeDistributed(Conv2D(64, (3, 3), activation="tanh")),
        TimeDistributed(MaxPooling2D((2, 2))),
        TimeDistributed(
            Dropout(0.25),
        ),
...
model = Sequential(
    [
        ...
        LSTM(128, return_sequences=True, recurrent_activation="tanh"),
        TimeDistributed(Dense(128, activation="tanh")),
        TimeDistributed(
            Dropout(0.5),
        ),
        TimeDistributed(Dense(MAXNOTES * len(LABELS), activation="softmax")),
