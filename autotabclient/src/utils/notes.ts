...
export function genNotes(props: GenNotesI): [string[], string[][]] | [string[], string[][], number[]] {
	...
	if (indexes) {
		return [uniqueNotes, stringNotes.reverse(), indexLabels(notes)];
	}

	return [uniqueNotes, stringNotes.reverse()];
}
